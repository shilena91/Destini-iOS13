...
struct StoryBrain {
    ...
    func storyChoices() -> [String] {
        let choice1 = story[storyNumber].choice1
        let choice2 = story[storyNumber].choice2
        
        return ([choice1, choice2])
    }
    
    func choiceDes() -> [Int] {
        let choice1Des = story[storyNumber].choice1Destination
        let choice2Des = story[storyNumber].choice2Destination
        
        return ([choice1Des, choice2Des])
    }
